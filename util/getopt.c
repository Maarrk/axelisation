...
// Added by me to build outside of gcc
#include "stdbool.h"
#include "stdlib.h"
...
char cgetopt_getopt(int argc, char *argv[], char *optstring) {
...
int cgetopt_cgetopt_long(int argc, char *argv[], char *optstring, const struct option *longopts,
                         int *longindex) {
...
int cgetopt_cgetopt_long_only(int argc, char *argv[], char *optstring,
...
cgetopt_Options *cgetopt_InitOptions(void) {
...
cgetopt_Options *cgetopt_KillOptions(cgetopt_Options *o) {
    free(o->cinfo);
    free(o);
    return NULL;
}
...
void cgetopt_SetOption(cgetopt_Options *o, unsigned int index, char *name, bool has_arg, int *flag,
                       int val) {
    if (index > o->high) {
...
struct option *cgetopt_GetLongOptionArray(cgetopt_Options *o) { return o->cinfo; }

/* GNU Modula-2 linking fodder.  */

void _M2_cgetopt_init(void) {}

void _M2_cgetopt_finish(void) {}
